...
<div class="d-flex justify-content-between align-items-center">
    ...
    <a class="btn btn-primary" href="{{ route('admin.conferences.create') }}">{{ __('messages.create_conference') }}</a>
</div>
<table class="table table-striped bg-white shadow-sm mt-3">
    ...
    @foreach ($conferences as $conference)
        <tr>
            ...
            <td>
                <a class="btn btn-sm btn-outline-primary" href="{{ route('admin.conferences.show', $conference['id']) }}">{{ __('messages.view') }}</a>
